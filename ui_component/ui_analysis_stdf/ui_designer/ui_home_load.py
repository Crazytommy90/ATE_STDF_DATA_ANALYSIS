...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/pyqt/source/images/lc_linestyle.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_qt_scatter.setIcon(icon5)
        self.action_qt_visual_map = QAction(MainWindow)
        self.action_qt_visual_map.setObjectName(u"action_qt_visual_map")
        icon6 = QIcon()
        icon6.addFile(u":/pyqt/source/images/lc_objectcatalog.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_qt_visual_map.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/pyqt/source/images/lc_aligndown.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_qt_distribution_trans.setIcon(icon7)
        self.action_qt_mapping = QAction(MainWindow)
        self.action_qt_mapping.setObjectName(u"action_qt_mapping")
        icon8 = QIcon()
        icon8.addFile(u":/pyqt/source/images/lc_graphicfiltermosaic.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_qt_mapping.setIcon(icon8)
        self.action_summary = QAction(MainWindow)
        self.action_summary.setObjectName(u"action_summary")
        icon9 = QIcon()
        icon9.addFile(u":/pyqt/source/images/lc_dbformrename.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_summary.setIcon(icon9)
        ...
        self.toolBar.addAction(self.action_qt_mapping)
        self.toolBar.addAction(self.action_qt_visual_map)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_summary)
        self.toolBar.addSeparator()
        self.toolBar.addAction(self.action_capability)
...
#endif // QT_CONFIG(tooltip)
        self.action_qt_mapping.setText(QCoreApplication.translate("MainWindow", u"mapping", None))
#if QT_CONFIG(tooltip)
        self.action_qt_mapping.setToolTip(QCoreApplication.translate("MainWindow", u"Mapping\u56fe", None))
#endif // QT_CONFIG(tooltip)
        self.action_summary.setText(QCoreApplication.translate("MainWindow", u"Summary", None))
#if QT_CONFIG(tooltip)
        self.action_summary.setToolTip(QCoreApplication.translate("MainWindow", u"\u751f\u6210Summary\u62a5\u544a", None))
#endif // QT_CONFIG(tooltip)
